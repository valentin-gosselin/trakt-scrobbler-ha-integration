...
### Added
- Integration icon and logo (submitted to home-assistant/brands so the integration page shows an icon instead of the placeholder).

### Changed
- README: document the Trakt card's visual editor.
